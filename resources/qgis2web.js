...
map.getView().fit([564669.031642, 5707699.498129, 1363871.056766, 6112574.432684], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">JTI Switzerland</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (13 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Test demo map';
            }
